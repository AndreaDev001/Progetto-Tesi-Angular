...
import { Board, BoardMember, CheckList, CheckListOption, CollectionModel, Tag, Task, TaskAssignment } from 'src/model/interfaces';
...
import { createTaskAssignment } from 'src/model/create';
...
export class TaskOverlayComponent implements OnInit 
{
  ...
  constructor(private taskAssignmentsService: TaskAssignmentService,private alertHandlerService: AlertHandlerService,private taskService: TaskService,private checkListOptionService: CheckListOptionService,private tagService: TagService,private checkListService: CheckListService) {
